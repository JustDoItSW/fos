 ...
 * @Company: CSUFT
 * @Description: 点击进入MainActivity，引导页结束
 * @date 2018/5/2 21:53
 */

public class WelcomeLauncherFragment extends LauncherBaseFragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rooView=inflater.inflate(R.layout.fragment_welcome_launcher, null);
    ...
    public void onClick(View v) {
        SharedPreferences.Editor editor=getActivity().getSharedPreferences(MainActivity.PREFERENCE_NAME,MODE_PRIVATE).edit();
